        ...
        <div className=" text-center text-sm sm:text-[0.65rem] sm:leading-tight md:leading-snug">
          <div ref={setRefs} className="myElement mb-2">
            <p>
              ...
              pertama dan terbesar yang resmi mengoperasikan sewa jeep wisata di
              kawasan Galunggung! Kami bangga menjadi pionir dalam industri ini
              dan menawarkan pengalaman berkendara yang tak terlupakan di
          ...
          <div ref={setRefs} className="myElement mb-2">
            ...
            <p>
              ...
              Bergabunglah dengan kami dan rasakan sensasi offroad di medan yang
              menantang dengan pemandangan alam Galunggung yang menakjubkan. Ayo
              jelajahi keindahan alam dan budaya lokal dengan gaya petualangan
              yang sesungguhnya! Ikuti kami di media sosial kami untuk
              mendapatkan informasi lebih lanjut tentang paket wisata, rute
              petualangan, dan promo eksklusif. Bergabung sekarang dan jadilah
              bagian dari komunitas petualang sejati!
            </p>
          </div>
